...
class GATGCNFG(GAT_GCN):
    def __init__(self, n_output=1, num_features_xd=78, num_features_xt=25,
                 n_filters=32, embed_dim=128, output_dim=128, dropout=0.2, fg_hidden_size=300,
                 device=torch.device('cpu')):
        super(GATGCNFG, self).__init__(n_output, num_features_xd, num_features_xt,
