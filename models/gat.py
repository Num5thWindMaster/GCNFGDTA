...
class GATFG(GATNet):
    def __init__(self, num_features_xd=78, n_output=1, num_features_xt=25,
                     n_filters=32, embed_dim=128, output_dim=128, dropout=0.2, fg_hidden_size=300, device=torch.device('cpu')):
        super(GATFG, self).__init__(num_features_xd, n_output, num_features_xt,
