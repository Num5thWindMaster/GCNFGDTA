...
with (open('CAS_name.txt', 'r', encoding='utf-8') as file1):
    ...
    for k in name_list:
        ...
        for l in results:
            try:
                print('CID: {}\tMass: {}\tName: {}\tMolfor: {}\tSmi: {}\tSyn: {}'.format(l.cid, l.exact_mass,
                                                                                         l.iupac_name,
                                                                                         l.molecular_formula,
                                                                                         l.isomeric_smiles, l.synonyms))
